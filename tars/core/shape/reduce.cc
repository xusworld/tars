#ifndef TARS_CORE_SHAPE_REDUCE_H_
#define TARS_CORE_SHAPE_REDUCE_H_
...
class ReduceShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(ReduceShapeInfer);

  virtual ~ReduceShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_REDUCE_H_