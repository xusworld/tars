#ifndef TARS_CORE_SHAPE_SEGMENT_H_
#define TARS_CORE_SHAPE_SEGMENT_H_
...
class SegmentShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(SegmentShapeInfer);

  virtual ~SegmentShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_SEGMENT_H_