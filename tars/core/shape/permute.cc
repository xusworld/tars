#ifndef TARS_CORE_SHAPE_PERMUTE_H_
#define TARS_CORE_SHAPE_PERMUTE_H_
...
class PermuteShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(PermuteShapeInfer);

  virtual ~PermuteShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_PERMUTE_H_