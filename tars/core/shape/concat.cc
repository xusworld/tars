#ifndef TARS_CORE_SHAPE_CONCAT_H_
#define TARS_CORE_SHAPE_CONCAT_H_
...
class ConcatShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(ConcatShapeInfer);

  virtual ~ConcatShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_CONCAT_H_