#ifndef TARS_CORE_SHAPE_CONV2D_H_
#define TARS_CORE_SHAPE_CONV2D_H_
...
class Conv2DShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(Conv2DShapeInfer);

  virtual ~Conv2DShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_CONV2D_H_