#ifndef TARS_CORE_SHAPE_FLATTEN_H_
#define TARS_CORE_SHAPE_FLATTEN_H_
...
class FlattenShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(FlattenShapeInfer);

  virtual ~FlattenShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_FLATTEN_H_