#ifndef TARS_CORE_SHAPE_CAST_H_
#define TARS_CORE_SHAPE_CAST_H_
...
// Op shape inference.
class CastShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(CastShapeInfer);

  virtual ~CastShapeInfer() = default;
