#ifndef TARS_CORE_SHAPE_SELECT_H_
#define TARS_CORE_SHAPE_SELECT_H_
...
class SelectShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(SelectShapeInfer);

  virtual ~SelectShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_SELECT_H_