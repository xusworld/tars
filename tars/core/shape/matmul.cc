#ifndef TARS_CORE_SHAPE_MATMUL_H_
#define TARS_CORE_SHAPE_MATMUL_H_
...
class MatmulShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(MatmulShapeInfer);

  virtual ~MatmulShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_MATMUL_H_