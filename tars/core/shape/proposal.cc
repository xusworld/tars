#ifndef TARS_CORE_SHAPE_PROPOSAL_H_
#define TARS_CORE_SHAPE_PROPOSAL_H_
...
class ProposalShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(ProposalShapeInfer);

  virtual ~ProposalShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_PROPOSAL_H_