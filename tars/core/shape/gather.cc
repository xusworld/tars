#ifndef TARS_CORE_SHAPE_GATHER_H_
#define ARS_CORE_SHAPE_GATHER_H_
...
class GatherShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(GatherShapeInfer);

  virtual ~GatherShapeInfer() = default;
