#ifndef TARS_CORE_SHAPE_RANGE_H_
#define TARS_CORE_SHAPE_RANGE_H_
...
class RangeShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(RangeShapeInfer);

  virtual ~RangeShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_RANGE_H_