#ifndef TARS_CORE_SHAPE_CONVERT_H_
#define TARS_CORE_SHAPE_CONVERT_H_
...
class ConvertShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(ConvertShapeInfer);

  virtual ~ConvertShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_CONVERT_H_