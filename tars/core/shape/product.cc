#ifndef TARS_CORE_SHAPE_PRODUCT_H_
#define TARS_CORE_SHAPE_PRODUCT_H_
...
class ProductShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(ProductShapeInfer);

  virtual ~ProductShapeInfer() = default;
...
#endif  // TARS_CORE_SHAPE_PRODUCT_H_