#ifndef TARS_CORE_SHAPE_POOL_H_
#define TARS_CORE_SHAPE_POOL_H_
...
class PoolShapeInfer : public ShapeInfer {
 public:
  DISABLE_COPY_MOVE_ASSIGN(PoolShapeInfer);

  virtual ~PoolShapeInfer() = default;
